...
This **`r pkg_GenInfo$package`** package report was generated using  **`r params$version`** riskmetric version .  Metrics were reviewed via the R Package Risk Assessment Application.</div>
